...
app.config['MAIL_USERNAME'] = 'longdznhattg102@gmail.com'  # Thay thế bằng email của bạn
app.config['MAIL_PASSWORD'] = 'cvdp splc wohv nrdx'  # Thay thế bằng mật khẩu ứng dụng của bạn
